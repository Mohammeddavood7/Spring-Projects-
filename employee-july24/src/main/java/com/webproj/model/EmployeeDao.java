...
public class EmployeeDao extends JdbcTemplate implements EmployeeINF {
	...
	public int InsertEmployee(Employee emp) {
		return update(INSERT, new Object[] { emp.getEmpName(), emp.getEmpAddress(), Double.valueOf(emp.getEmpSalary()) });

	}

	@Override
	public int updateEmployee(Employee emp) {
		return update(UPDATE, new Object[] { emp.getEmpName(), emp.getEmpAddress(), emp.getEmpSalary(), emp.getEmpId() });
